...
class Item(models.Model):
    title = models.CharField(max_length=100)
    item_image1 = models.ImageField(upload_to='item_images/')
    item_image2 = models.ImageField(upload_to='item_images/')
    item_image3 = models.ImageField(upload_to='item_images/')
    item_details = models.TextField()
    item_quantity = models.TextField()
    price = models.CharField(max_length=50, blank=True, default='')
    discount_price = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)  # Add this field if it's missing
    is_active = models.BooleanField(default=True)
    specification_image = models.ImageField(upload_to='specification_images/')
